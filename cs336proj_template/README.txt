...
[x] change your own profile info JA 
     [x] add new cars and change existing ones from your profile JA
     [x] add new hobbies and change existing ones from your profile JA
   Optional:
...
[x] search for a user by profile info JA
[x] view another user's profile info JA
     [x] view their their cars, hobbies JA
     [x] make a friend request JA
  Optional:
